        ...
        <div class="otherside scroll">
            ...
            <div class="subject2">
                ...
                <table class="table"  >
                    <thead >
                        <tr>
                            <th colspan="4" class="table_title"> <p class="registered">Exams </p></th>
                    ...
                    <tr align="center" class="details" >
                       ...
                       <td  class="details"><button><a href="startexam.php?subject_id=<?php echo $row['id']?>">start</a></button></td>
